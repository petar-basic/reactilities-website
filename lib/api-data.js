...
export const API_DATA = [
  { category: "DOM", name: "useBattery", description: "Monitor battery level and charging status", docsPath: "src/dom/useBattery/README.md" },
  ...
  { category: "DOM", name: "useOrientation", description: "Track portrait/landscape device orientation", docsPath: "src/dom/useOrientation/README.md" },
  ...
  { category: "DOM", name: "usePortal", description: "Create a portal root mounted to document.body", docsPath: "src/dom/usePortal/README.md" },
  ...
  { category: "DOM", name: "useRovingTabIndex", description: "Accessible keyboard navigation for item groups", docsPath: "src/dom/useRovingTabIndex/README.md" },
  ...
  { category: "DOM", name: "useScrollTo", description: "Programmatic scrolling helpers for page and elements", docsPath: "src/dom/useScrollTo/README.md" },
  ...
  { category: "STATE", name: "useClipboard", description: "Read and write clipboard content with status helpers", docsPath: "src/state/useClipboard/README.md" },
  ...
  { category: "STATE", name: "useStep", description: "Navigate bounded multi-step flows", docsPath: "src/state/useStep/README.md" },
  ...
  { category: "UTILITY", name: "useAutoSave", description: "Auto-save changing data with status tracking", docsPath: "src/utils/useAutoSave/README.md" },
  ...
  { category: "UTILITY", name: "useDebounceCallback", description: "Debounce callback execution", docsPath: "src/utils/useDebounceCallback/README.md" },
  { category: "UTILITY", name: "useDragAndDrop", description: "File drag-and-drop handling with validation", docsPath: "src/utils/useDragAndDrop/README.md" },
  { category: "UTILITY", name: "useEventSource", description: "Manage server-sent events (SSE) streams", docsPath: "src/utils/useEventSource/README.md" },
  ...
  { category: "UTILITY", name: "useFileReader", description: "Read files as text, data URL, or ArrayBuffer", docsPath: "src/utils/useFileReader/README.md" },
  { category: "UTILITY", name: "useGeolocation", description: "Access user geolocation", docsPath: "src/utils/useGeolocation/README.md" },
  { category: "UTILITY", name: "useIdleTimeout", description: "Detect user inactivity with timeout callbacks", docsPath: "src/utils/useIdleTimeout/README.md" },
  { category: "UTILITY", name: "useImageLazyLoad", description: "Lazy-load images when they enter viewport", docsPath: "src/utils/useImageLazyLoad/README.md" },
  ...
  { category: "UTILITY", name: "useLogger", description: "Log component lifecycle and prop changes", docsPath: "src/utils/useLogger/README.md" },
  ...
  { category: "UTILITY", name: "useSpeechRecognition", description: "Capture voice input with Web Speech API", docsPath: "src/utils/useSpeechRecognition/README.md" },
  { category: "UTILITY", name: "useSpeechSynthesis", description: "Text-to-speech controls with voice selection", docsPath: "src/utils/useSpeechSynthesis/README.md" },
  { category: "UTILITY", name: "useThrottle", description: "Throttle rapidly changing values", docsPath: "src/utils/useThrottle/README.md" },
  { category: "UTILITY", name: "useThrottleCallback", description: "Throttle callback execution", docsPath: "src/utils/useThrottleCallback/README.md" },
  ...
  { category: "UTILITY", name: "useWhyDidYouRender", description: "Debug unnecessary re-renders in development", docsPath: "src/utils/useWhyDidYouRender/README.md" },
  { category: "UTILITY", name: "useWorker", description: "Run heavy logic in a Web Worker", docsPath: "src/utils/useWorker/README.md" },
